...
The white race on here still holds the highest percentage fo people who are for capital punishment rather than the other races. The p-values are still low, but there are differences between all the races and not just 2 on thenumber 2 branch. But with all the races still having different data. The black race is the race that is mroe opposed to capital punihsmnet while on the number 2 branch, the other race held the highest. 
